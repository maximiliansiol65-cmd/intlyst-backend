...
const NAV_ITEMS = [
  ...
  { type: "page", icon: "⚙",  label: "Einstellungen", desc: "Account, Integrationen, Team", to: "/settings" },
  { type: "settings", icon: "🎯", label: "Strategie setzen",  desc: "Wachstumsziel festlegen",     to: "/settings?tab=strategie" },
  { type: "settings", icon: "🔗", label: "Integrationen",     desc: "Stripe, GA4, Shopify verbinden", to: "/settings?tab=integrationen" },
