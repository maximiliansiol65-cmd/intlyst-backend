  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
        <span style={{ fontSize: 12, fontWeight: 600, color: "#e2e8f0" }}>{b.metric_label}</span>
        <span
          style={{
            fontSize: 10,
            fontWeight: 700,
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 20 }}>
        <div>
          <h1 style={{ fontSize: 20, fontWeight: 700, color: "#f1f5f9", margin: 0 }}>Markt & Standort</h1>
            ...
            <>
              ...
              >
                <div style={{ background: season?.bg, border: `1px solid ${season?.color}30`, borderRadius: 10, padding: "12px 16px" }}>
                  ...
                  <div style={{ fontSize: 12, color: "#94a3b8", marginTop: 2 }}>{data.season_label}</div>
                </div>
                <div style={{ background: "#13131f", border: "1px solid #e8e8ed", borderRadius: 10, padding: "12px 16px", fontSize: 13, color: "#94a3b8", lineHeight: 1.6 }}>
                  {data.summary}
                </div>
              </div>
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <div style={{ background: "#13131f", border: "1px solid #e8e8ed", borderRadius: 12, padding: "14px 16px" }}>
                ...
                <div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    {data.trends.map((t, i) => {
                      ...
                      return (
                        <div key={i} style={{ background: "#13131f", border: "1px solid #e8e8ed", borderRadius: 8, padding: "10px 13px", display: "flex", alignItems: "center", gap: 10 }}>
                          <span style={{ fontSize: 14, color: tc.color }}>{tc.icon}</span>
                          <div style={{ flex: 1 }}>
                            <div style={{ fontSize: 12, fontWeight: 600, color: "#e2e8f0" }}>{t.keyword}</div>
      ...
      {tab === "trends" && (
        <div>
          <div style={{ marginBottom: 20 }}>
            ...
            <div style={{ background: "#13131f", border: "1px solid #e8e8ed", borderRadius: 12, padding: "18px" }}>
