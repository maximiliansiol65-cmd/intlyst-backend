    ...
    >
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 10, marginBottom: 12 }}>
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 13, fontWeight: 600, color: "#f1f5f9" }}>{test.name}</div>
        </div>
  ...
  if (!data) {
    return (
      <div style={{ background: "#f5f5f7", border: "1px solid #11111120", borderRadius: 12, padding: "18px" }}>
        ...
        <div style={{ fontSize: 14, fontWeight: 600, color: "#f1f5f9", marginBottom: 4 }}>Test kann nicht geoeffnet werden</div>
        <div style={{ fontSize: 12, color: "#94a3b8" }}>{error || "Die API hat keine gueltigen Testdaten geliefert."}</div>
      </div>
    );
  }
    ...
    <div>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 20 }}>
        <div>
          ...
          <h2 style={{ fontSize: 16, fontWeight: 700, color: "#f1f5f9", margin: 0 }}>{data.name}</h2>
          {data.hypothesis && (
        ...
        {data.winner && data.significance.significant && (
          <div style={{ background: "#33333318", border: "1px solid #33333320", borderRadius: 10, padding: "10px 16px", textAlign: "center" }}>
            ...
            <div style={{ fontSize: 15, fontWeight: 700, color: "#f1f5f9" }}>{data.winner_name}</div>
      ...
      {data.ai_verdict && (
        <div style={{ background: "#f5f5f7", border: "1px solid #00000020", borderRadius: 10, padding: "14px 16px", marginBottom: 20 }}>
          ...
          <div style={{ fontSize: 13, color: "#94a3b8", lineHeight: 1.6, marginBottom: 8 }}>{data.ai_verdict}</div>
        ...
        {[
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
              <span style={{ fontSize: 13, fontWeight: 600, color: "#f1f5f9" }}>{variant.name}</span>
...
function NewTestForm({ onCreated, onCancel }) {
  ...
  return (
    <div style={{ background: "#f5f5f7", border: "1px solid #e8e8ed", borderRadius: 12, padding: "20px", marginBottom: 20 }}>
      <div style={{ fontSize: 14, fontWeight: 600, color: "#f1f5f9", marginBottom: 16 }}>Neuer A/B-Test</div>
...
export default function ABTests() {
  ...
  if (activeId) {
    return (
      <div style={{ minHeight: "100vh", background: "#0a0a14", color: "#1d1d1f", fontFamily: "'DM Sans','Segoe UI',sans-serif", padding: "28px 32px" }}>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a14", color: "#1d1d1f", fontFamily: "'DM Sans','Segoe UI',sans-serif", padding: "28px 32px" }}>
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 24 }}>
        <div>
          <h1 style={{ fontSize: 20, fontWeight: 700, color: "#f1f5f9", margin: 0 }}>A/B Tests</h1>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 10, marginBottom: 20 }}>
        {[
          { label: "Tests gesamt", value: tests.length, color: "#f1f5f9" },
