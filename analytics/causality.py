...
def build_causality_context(bundle: CausalityBundle) -> str:
    """
    Formatiert CausalityBundle als präzisen Kontext-String für Claude.

    Enthält nur statistisch relevante Kausalitäten.
    """
    lines: list[str] = ["KAUSALITÄTSANALYSE:"]
    lines.append(bundle.causal_chain_summary)
